    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="bg-blue-600 px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <span class="bg-blue-700 text-white text-sm px-3 py-1 rounded-full">{{$data->conge->type}}</span>
            </div>
        </div>
        ...
        <div class="p-6">
            ...
            <div class="relative pb-8">
                ...
                <div class="flex items-center mb-6 relative">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-gray-800 font-medium">{{$data->conge->created_at}}</p>
                    </div>
                </div>
                <!-- Start Date -->
                <div class="flex items-center mb-6 relative">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-gray-800 font-medium">{{$data->conge->start_at}}</p>
                    </div>
                </div>
                ...
                <div class="flex items-center mb-6 relative">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-gray-800 font-medium">{{$data->conge->duration}} jours</p>
                    </div>
                </div>
                ...
                <div class="flex items-center relative">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-gray-800 font-medium">{{$data->conge->end_at}}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6 pt-6 border-t border-gray-200">
                ...
                <p class="text-gray-700 bg-gray-50 p-3 rounded-md">{{$data->conge->motif}}</p>
            </div>
